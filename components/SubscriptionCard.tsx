...
const SubscriptionCard: React.FC<Props> = ({ subscription, onClick, t, language }) => {
  ...
  return (
    <div 
      ...
      className={`relative group p-5 rounded-3xl border ${statusColor} transition-all duration-200 active:scale-[0.98] cursor-pointer shadow-sm hover:shadow-md h-full`}
    >
