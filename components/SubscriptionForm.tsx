...
const SubscriptionForm: React.FC<Props> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full h-full md:h-auto md:max-h-[85vh] md:max-w-lg md:rounded-3xl bg-white dark:bg-slate-900 shadow-2xl flex flex-col animate-in slide-in-from-bottom-4 md:zoom-in-95 duration-300 overflow-hidden transition-colors">
